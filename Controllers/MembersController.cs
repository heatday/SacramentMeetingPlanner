...
namespace SacramentPlanner.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Bishopric")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Bishopric")] Member member)
        {
            if (id != member.Id)
            {
                return NotFound();
